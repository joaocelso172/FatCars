...
import static com.example.fatcars.adapter.informCarro.desligarBot;

public class informLateral extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inform_lateral);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.inform_lateral, menu);
        return true;
    }
